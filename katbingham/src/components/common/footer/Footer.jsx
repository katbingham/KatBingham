        ...
        <div className="footer">
            <div className="social-links-parent">
                <div className="social-links">
                    <a id="github-link" target="_blank" href="https://github.com/katbingham"> <Github/></a> 
                    <a id="linkedin-link" target="_blank" href="https://www.linkedin.com/in/kathryn-bingham-a56796a4/"> <Linkedin/></a>
